"""
Django settings for serverRUI project.
...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", default='localhost 172.22.13.148 192.168.0.21').split(" ")
